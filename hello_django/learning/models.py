...
class Customer(models.Model):
    # 客户信息表 32=大概是十个字 black=限制django-admin null=空值
...
class CourseRecord(models.Model):
    ...
    outline = models.TextField(verbose_name="本节上课大纲")
